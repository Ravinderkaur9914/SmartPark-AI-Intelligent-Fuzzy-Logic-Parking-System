# 🅿️ SmartPark AI — Intelligent Fuzzy Logic Parking System
...
| Membership Functions | AI Chat + History |
|---|---|
| ![Membership Functions](screenshots/membership-functions.png) | ![History Log](screenshots/history-log.png) |
...
cp .env.example .env
```
Then open `.env` and paste in your free Groq API key from [console.groq.com](https://console.groq.com).
